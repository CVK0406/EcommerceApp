    ...
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="tv.jsp" style="text-decoration:none; color:#333;">TV</a>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="laptop.jsp" style="text-decoration:none; color:#333;">Laptop</a>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="mobile.jsp" style="text-decoration:none; color:#333;">Mobile</a>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="watch.jsp" style="text-decoration:none; color:#333;">Watch</a>
        </div>
      </div>
    </div>
  </div>
