...
<div class="hero-section">
  ...
  <div class="search-container">
    <form action="searchc.jsp" method="get" class="search-form">
...
<div class="scrollmenu" style="max-width: 1200px">
  <%-- Business logic and data access remain unchanged --%>
  <%
