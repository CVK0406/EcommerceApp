...
<div class="product-card">
  ...
  <div class="product-info">
    ...
    <a class="add-to-cart-btn" href='addtocart?id=<%=l.getBname()%>&ie=<%=l.getCname()%>&ig=<%=l.getPname()%>&ih=<%=l.getPprice()%>&ii=1&ij=<%=l.getPimage() != null && !l.getPimage().trim().isEmpty() ? l.getPimage() : "no-image.png" %>&N=<%=N%>' onclick="return updateCartQuantity(this)">Add To Cart</a>
