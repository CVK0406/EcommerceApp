...
<div class="cart-table">
    ...
    %>
            ...
            <% for(cart v : listv) { %>
                <div class="cart-item-row">
                    <div class="cart-item-img">
                        ...
                        %>
                        <img src="<%=imagePath != null ? imagePath : "images/no-image.png"%>" 
                             alt="<%=v.getPname()%>" 
                             loading="lazy"
                             width="90"
                             height="90"
                    ...
                    <div class="cart-item-info">
                        ...
                        <div style="color:#888; font-size:0.98rem;">
                            Brand: <%=v.getBname()%> | Category: <%=v.getCname()%>
                        </div>
                    </div>
                    <div class="cart-item-qty">
                        <span style="background:#ffe5d9; padding:6px 18px; border-radius:6px; font-weight:500;">
                            Qty: <%=v.getPquantity()%>
                        </span>
                    </div>
                    ...
                    <div class="cart-item-remove">
                        <a href='removecart?id=<%=N%>&cartId=<%=v.getCart_id()%>' title="Remove">
        ...
        <div style="text-align: right; margin-top: 24px;">
            ...
            <% if(Total != 0) { %>
                <a href="ShippingAddress.jsp?Total=<%=Total%>" class="proceed-btn">Proceed To Checkout</a>
            <% } else { %>
