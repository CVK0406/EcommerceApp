    ...
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="tvc.jsp" style="text-decoration:none; color:#333;">TV</a>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="laptopc.jsp" style="text-decoration:none; color:#333;">Laptop</a>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="mobilec.jsp" style="text-decoration:none; color:#333;">Mobile</a>
        </div>
      </div>
    </div>
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex">
      <div class="category-card w-100">
        ...
        <div class="category-title">
          <a href="watchc.jsp" style="text-decoration:none; color:#333;">Watch</a>
        </div>
      </div>
    </div>
  </div>
