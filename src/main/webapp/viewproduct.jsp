                ...
                <div class="search-container">
                  <form action="#" method="get" class="search-form" onsubmit="return false;">
                    <input type="text" id="searchInput" class="search-input"
                      placeholder="Search products by name or brand..." onkeyup="filterProducts()" autocomplete="off">
                  </form>
                </div>
                <div class="container">
                  <div class="row" id="productList">
                    <% DAO2 dao=new DAO2(DBConnect.getConn()); List<viewlist> listv = dao.getAllviewlist();
                      ...
                      <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4 d-flex product-item"
                        data-name="<%= v.getPname().toLowerCase() %> <%= v.getBname().toLowerCase() %>">
